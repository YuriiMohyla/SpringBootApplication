...
public class Controller {
    ...
    @GetMapping("/info")
    public LastFmObject getObject(@RequestParam(value = "name", defaultValue = "Believe") String name, @RequestParam(value = "artist", defaultValue = "Cher") String artist) {
